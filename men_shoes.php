    ...
    <div class="container-fluid" style="margin-top:118px;">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Men Shoes</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2 side_bar">
                <form action="#" mehod="post" id="form_filter">
                    <div id="accordion">
                        ...
                        <details class="accordion border border-0 mb-2 p-1">
                            <summary class="accordion-header">
                                <div class="accordion-header-content">
                                    <span class="accordion-header-content-label text-dark">Line Material</span>
                                </div>
                            </summary>
                            <div class="accordion-content">
                                <div class="card-body">
                                ...
                                <div class="single-product card_section">
                                    <div class="product-img product_image">
                                        <a href="men_Shoes_desc.php"><img class="img-fluid w-100"
                                                src="img/product/inspired-product/i4.jpg" alt="" /></a>
