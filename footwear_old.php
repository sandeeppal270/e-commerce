...
<head>
    ...
    <title>Ecommerce / Footwear</title>
    <!-- Bootstrap CSS -->
    ...
    <link rel="stylesheet" href="css/footwear/footwearstyle.css" />
    <script src="css/footwear/footwear.js"></script>
    ...
    <div class="container-fluid" style="margin-top:118px;">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Footwear</li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-7 col-sm-7">
                <ul class="d-flex">
                    <!-- <li class="p-1"><a href="#">Casual Shoes</a></li>
                    <li class="p-1"><a href="#">Ethnic Shoes</a></li>
                    <li class="p-1"><a href="#">Formal Shoes</a></li>
                    <li class="p-1"><a href="#">Party Shoes</a></li>
                    <li class="p-1"><a href="#">Sports Shoes</a></li> -->
                </ul>
            </div>
                ...
                <div id="accordion">
                    <div class="card active">
                        <div class="card-header" id="headingGender">
                            <h5 class="mb-0">
                                <span>Gender</span><button class="btn btn-link collapsed gender_button" data-toggle="collapse"
                                    onclick="genderFunction()" data-target="#collapseGender" aria-expanded="false"
                                    aria-controls="collapseGender"><i class="fa fa-angle-down"></i>

                                </button>
                            </h5>
                        </div>
                        <div id="gender" class="collapse" aria-labelledby="headingGender" data-parent="#accordion">
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0">
                                <span>Size</span><button class="btn btn-link collapsed size_button" onclick="sizeFunction()"
                        ...
                        <div id="size" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                                <span>Brand</span><button class="btn btn-link collapsed brand_button" onclick="brandFunction()"
                        ...
                        <div id="brand" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingThree">
                            <h5 class="mb-0">
                                <span>Price</span><button class="btn btn-link collapsed price_button" onclick="priceFunction()"
                                    data-toggle="collapse" data-target="#collapseThree" aria-expanded="false"
                                    aria-controls="collapseThree"><i class="fa fa-angle-down"></i>

                                </button>
                            </h5>
                        </div>
                        <div id="price" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                            <div class="card-body">
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                    ...
                                    <p class="form-control">Rs. 0 To Rs. 1000</p>
                                </div>
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                    ...
                                    <p class="form-control">Rs. 1001 To Rs. 2000</p>
                                </div>
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingFour">
                            <h5 class="mb-0">
                                <span>Heel Type</span><button class="btn btn-link collapsed heeltype_button" data-toggle="collapse"
                                    onclick="heeltypeFunction()" data-target="#collapseFour" aria-expanded="false"
                    ...
                    <div class="card">
                        <div class="card-header" id="headingFive">
                            <h5 class="mb-0">
                                <span>Heel Height</span><button class="btn btn-link collapsed heelheight_button" data-toggle="collapse"
                                    onclick="heelheightFunction()" data-target="#collapseFive" aria-expanded="false"
                                    aria-controls="collapseFive">
                                   <i class="fa fa-angle-down"></i>
                                </button>
                            </h5>
                        </div>
                        <div id="heelheight" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
                            <div class="card-body">
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingSix">
                            <h5 class="mb-0">
                                <span>Type</span><button class="btn btn-link collapsed type_button" onclick="typeFunction()" data-toggle="collapse"
                    ...
                    <div class="card">
                        <div class="card-header" id="headingSeven">
                            <h5 class="mb-0">
                                <span>Lining Material</span><button class="btn btn-link collapsed lining_button" onclick="liningFunction()" data-toggle="collapse"
                    ...
                    <div class="card">
                        <div class="card-header" id="headingAge">
                            <h5 class="mb-0">
                                <span>Age</span><button class="btn btn-link collapsed age_button" onclick="ageFunction()" data-toggle="collapse"
                                    data-target="#collapseAge" aria-expanded="false" aria-controls="collapseAge">
                                    <i class="fa fa-angle-down"></i>
                                </button>
                            </h5>
                        </div>
                        <div id="age" class="collapse" aria-labelledby="headingAge" data-parent="#accordion">
                            <div class="card-body">
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                    ...
                                    <p class="form-control">0.5 - 1.0</p>
                                </div>
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                    ...
                                    <p class="form-control">2.0 - 3.0</p>
                                </div>
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                    ...
                                    <p class="form-control">4.0 - 5.0</p>
                                </div>
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                    ...
                                    <p class="form-control">6.0 - 7.0</p>
                                </div>
                                <div class="input-group input-group-sm mb-1">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                    ...
                                    <p class="form-control">8.0 - 9.0</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header" id="headingEight">
                            <h5 class="mb-0">
                                <span>Colours</span><button class="btn btn-link collapsed colour_button" onclick="colourFunction()" data-toggle="collapse"
                                    data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                    <i class="fa fa-angle-down"></i>
                                </button>
                            </h5>
                        </div>
                        <div id="colour" class="collapse" aria-labelledby="headingEight" data-parent="#accordion">
                    ...
                    <div class="card">
                        <div class="card-header" id="headingNine">
                            <h5 class="mb-0">
                                <span>Occasion</span><button class="btn btn-link collapsed occasion_button" onclick="occasionFunction()"
