                    ...
                    <details class="accordion border border-0 mb-2 p-1">
                        ...
                        <div class="accordion-content">
                            <div class="card-body">
                                ...
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">Track suit</span>
                                </span>
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">Vests</span>
                                </span>
                            </div>
                        </div>
                    </details>
                    <!-- size<details class="accordion border border-0 mb-2 p-1">
                        <summary class="accordion-header">
                            <div class="accordion-header-content">
                    ...
                    <details class="accordion border border-0 mb-2 p-1">
                        ...
                        <div class="accordion-content">
                            <div class="card-body brand_container scroll_container">
                                ...
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">20% And Above</span>
                                </span>
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                ...
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">40% And Above</span>
                                </span>
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">50% And Above</span>
                                </span>
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">60% And Above</span>
                                </span>
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">70% And Above</span>
                                </span>
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">80% and Above</span>
                                </span>
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                    ...
                    <details class="accordion border border-0 mb-2 p-1">
                        ...
                        <div class="accordion-content">
                            <div class="card-body">
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
                                    <span class="ml-2">1.0 And Above</span>
                                </span>
                                <span class="d-flex">
                                    <input type="checkbox" aria-label="Checkbox for following text input">
