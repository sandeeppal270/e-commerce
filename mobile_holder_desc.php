    ...
    <div class="container-fluid" style="margin-top:118px;">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Electronic</a></li>
                <li class="breadcrumb-item"><a href="mobile_holders.php">Mobile Holder</a></li>
                <li class="breadcrumb-item active" aria-current="page">Mobile Holder Details</li>
        ...
        <div class="row main_section">
            <div class="col-md-2">
                <div class="row p-5">
                    <img class='slideshow-thumbnails active m-1 img-fluid' src='img/mobile_holder/mobile_holder1.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/mobile_holder/mobile_holder-2.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/mobile_holder/mobile_holder-3.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/mobile_holder/mobile_holder-4.jpg'>
                </div>
            </div>
            <div class="col-md-5">
                ...
                <div id='slideshow-items-container'>
                    <a href="#" data-toggle="modal" data-target=".bd-example-modal-lg">
                        <img class='slideshow-items active img-fluid' src='img/mobile_holder/mobile_holder1.jpg'>
                        <img class='slideshow-items img-fluid' src='img/mobile_holder/mobile_holder-2.jpg'>
                        <img class='slideshow-items img-fluid' src='img/mobile_holder/mobile_holder-3.jpg'>
                        <img class='slideshow-items img-fluid' src='img/mobile_holder/mobile_holder-4.jpg'>
                    </a>
            ...
            <div class="col-md-5">
                <div class="row">
                    <h2>ELV Mobile Phone Mount Tabletop Holder for Phones and Tablets</h2>
                </div>
                <div class="row mt-3">
                    <strong>Black</strong>
                ...
                <div class="row mt-3">
                    <span class="rupees"><span class="text-danger">- 6% </span><strong>Rs.
                            84.00</strong></span><small>M.R.P.:<del>₹ 89</del></small><br>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="product_name mt-2">ELV Mobile Phone Mount Tabletop Holder</div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
