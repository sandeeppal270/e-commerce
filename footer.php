    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 single-footer-widget">
                ...
                <div class="container">
                    <div class="row">
                        <small class="pt-3">EXPERIENCE ECOMMERCE APP ON MOBILE</small>

                        <div class="item d-flex">
                            <div class="col-lg-6 mt-4 pt-3">
                                <a href="itms-apps://" title="Download the App now"><svg width="113px" height="113px"
                                        viewBox="0 0 135.00 135.00" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                        fill="#000000" transform="rotate(0)">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"
                                            stroke="#CCCCCC" stroke-width="0.27"></g>
                            ...
                            <div class="col-lg-6">
                                <a href="itms-apps://" title="Download the App now"><svg width="113px" height="113px"
                                        viewBox="0 -189.93 539.856 539.856" xmlns="http://www.w3.org/2000/svg"
                                        fill="#000000">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
                                        </g>
                                        <g id="SVGRepo_iconCarrier">
                                            <g transform="scale(4.00216 4.0011)">
                                                ...
                                                <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="-23.235"
                                                    y1="97.431" x2="-23.235" y2="61.386"
        ...
        <div class="footer-bottom row align-items-center">
            ...
            <div class="col-lg-4 col-md-12 footer-social">
                ...
                <a href="#"><i class="fa fa-facebook" title="Follow to facebook"></i></a>
